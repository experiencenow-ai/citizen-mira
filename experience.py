...
def execute_tool(name: str, args: dict, state_file: Path, state: dict, current_model: str) -> str:
    ...
    if name == "list_files":
        ...
        allowed = ["echo", "date", "cat", "head", "tail", "ls", "mkdir", "cp", "mv", "rm", "find", "grep", "diff", "sort", "python3", "curl", "wget", "tar", "gzip", "base64", "sed", "awk", "pwd", "df", "du", "ps", "openssl", "sha256sum", "git", "ssh-keygen", "ssh", "eval" ]
        ...
        try:
            email_utils_file = home / "email_utils.py"
            if email_utils_file.exists():
                import importlib.util
                spec = importlib.util.spec_from_file_location("email_utils", email_utils_file)
